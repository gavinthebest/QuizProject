                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach var="user" items="${requestScope.users}" varStatus="counter">
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                    href="${pageContext.request.contextPath}/adminProfiles?suspend=${user.username}"
                                                    class="btn <c:if test="${user.suspended == 0}">btn-primary</c:if><c:if test="${user.suspended == 1}">btn-secondary</c:if>"
                                                    role="button"
                                                    aria-pressed="true">
                                                <c:if test="${user.suspended == 0}">Activated</c:if>
                                                <c:if test="${user.suspended == 1}">Suspended</c:if>
                                            </a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                ...
                                <ul class="pagination">
                                    <c:if test="${requestScope.currentPage != 1}">
                                        <li class="page-item"><a class="page-link"
                                                                 href="${pageContext.request.contextPath}/adminProfiles?currentPage=${currentPage-1}">Previous</a>
                                        </li>
                                    </c:if>
                                    ...
                                    <c:forEach begin="1" end="${requestScope.noOfPages}" var="i">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li class="page-item"><a class="page-link"
                                                                         href="${pageContext.request.contextPath}/adminProfiles?currentPage=${i}">${i}</a>
                                                </li>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:forEach>
                                    ...
                                    <c:if test="${requestScope.currentPage lt requestScope.noOfPages}">
                                        <li class="page-item"><a class="page-link"
                                                                 href="${pageContext.request.contextPath}/adminProfiles?currentPage=${currentPage+1}">Next</a>
                                        </li>
                                    </c:if>
                                </ul>
                            </nav>

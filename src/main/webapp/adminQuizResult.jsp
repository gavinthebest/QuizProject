...
<div class="container mt-5">
    <div class="d-flex justify-content-center row">
        <div class="col-md-10 col-lg-10">
            <ul class="list-group">
                <li class="list-group-item">${requestScope.quiz.username}'s ${requestScope.quiz.type} Quiz Result:</li>
                <li class="list-group-item">Starting time: ${requestScope.quiz.starttime}</li>
                <li class="list-group-item">Ending time: ${requestScope.quiz.endtime}</li>
                <li class="list-group-item">Result: ${requestScope.quiz.result}/10</li>
                <c:if test="${requestScope.result >= 6}">
                    <li class="list-group-item list-group-item-success">Passed</li>
                </c:if>
                <c:if test="${requestScope.result < 6}">
